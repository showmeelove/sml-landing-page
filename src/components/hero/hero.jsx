  ...
  return (
    <div className="mx-auto containr overflow-x-hidden">
      ...
      <div className="rounded-b-[60px] bg-[#010E2] py-[10px] ">
        <div className="mx-[19px] mt-[28px] md:mt-[30.5px] md:mx-[50px] flex items-center justify-between md:flex md:justify-between md:items-center">
          <a
            href="#"
          ...
          <nav className="hidden md:block">
            <ul className={`flex gap-[60px]`}>
              {navLinks.map((navLink) => (
                <li
                  key={navLink.text}
                  className={`font-figtree text-[20px] leading-[33px] font-medium text-center`}
                >
          ...
          <button className="hidden md:block px-[42px] py-[20px] font-figtree font-medium  text-[18px] leading-[33pxx] text-center rounded-[40px] bg-gradient-to-r from-[#1864FF] to-[#42AAFF]">
            sign up
          </button>
            ...
            <div className="block md:hidden">
              ...
              >
                ...
                <a className="mx-auto flex justify-center" href="#get">
                  <button
                    type="button"
                    className={`text-[18px] mb-[34px] bg-gradient-to-r from-[#1864FF] to-[#42AAFF] text-white rounded-[24px] leading-[21.94px] font-semibold font-mon text-center px-[42px] py-[18px] `}
                  >
                    sign up
                  </button>
                </a>
